...
# We observe that AIC values for the both model1 and model2 are low when compared with model3. We can also observe that AIC values for both model and model2 are equal.
...
#We can see that BIC values for model1 and model2 are less when compared with model3. We can also observe that BIC values for both model and model2 are equal.